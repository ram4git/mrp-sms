...
class Order extends Component {
  ...
  renderCart() {
    const {          area,
      ...
      console.log("PD=", priceDifference);
    return (
        ...
        <div className="summary w-full my-4 rounded-lg shadow-lg">
          ...
          <table className="summary">
            ...
            <tr className='p-1 my-2'>
              ...
              <td className="value text-green-600"><strong className='text-blue-600'>₹{parseFloat(lPrice).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</strong></td>
            </tr>
